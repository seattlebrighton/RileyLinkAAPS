...
public class RLHistoryItem {
    ...
    public RLHistoryItem(GregorianCalendar gregorianCalendar, RileyLinkServiceState serviceState, RileyLinkError errorCode) {
        this.dateTime = gregorianCalendar.get(Calendar.SECOND) //
                + gregorianCalendar.get(Calendar.MINUTE) * 100 //
                + gregorianCalendar.get(Calendar.HOUR_OF_DAY) * 10000 + gregorianCalendar.get(Calendar.DAY_OF_MONTH) * 1000000 + (gregorianCalendar.get(Calendar.MONTH) + 1) * 100000000 + gregorianCalendar.get(Calendar.YEAR) * 10000000000L;
